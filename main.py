...
<main>
 ...
 Контакты
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <form>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Братишь, почту введи, пожалуйста</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text">Мы не крысы, мы не передадим вашу почту в левые руки.</div>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3 form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Посмотри, вдруг что не так ввёл</label>
  </div>
